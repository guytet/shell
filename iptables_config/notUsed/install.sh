...
"0" )
	./check_ufw.sh  #Debian or Ubuntu, handle UFW disable
;;

"3" )
	./disable_firewalld.sh #CentOS, handle firewalld disable
;;

* )
	echo "This Linux version isn't supported, will now exit"
        exit 0;
;;
esac
...
#make sure it's all good, to STDOUT
iptables -L -n ;
